...
export default defineConfig(({ mode, command }) => {
  ...
  return {
      ...
      proxy: {
        ...
        "/comment": {
          target:
            "https://firebase-integration-backend-454546327917.us-central1.run.app/firebase-integration",
          changeOrigin: true,
          rewrite: (p) => p.replace(/^\/comment/, "/comment"),
        },
        "/reservation": {
          target:
            "https://firebase-integration-backend-454546327917.us-central1.run.app/firebase-integration",
          changeOrigin: true,
          rewrite: (p) => p.replace(/^\/reservation/, "/reservation"),
        },
      },
    },
    ...
    css: {
      ...
      preprocessorOptions: {
        scss: {
          additionalData: `@import "@/assets/styles/cover.scss";@import "@/assets/styles/menu1.scss";`,
        },
      },
    },
  };
